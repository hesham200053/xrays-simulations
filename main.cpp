...
//        testExp();
//        testSum();
//        cout << "Tests_successful_run" << endl;

        cSpectrum tmp;
        double minEnergy;
        double tubeVoltage = 75;
        string spectrumName;
        tmp.readSpectrum("/Users/Hesham/CLionProjects/Spectrum/SRO33100ROT350.dat", tubeVoltage, minEnergy , spectrumName);
